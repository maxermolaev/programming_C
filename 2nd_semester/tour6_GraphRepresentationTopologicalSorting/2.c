...
int matrix_get_free_columns(AdjacencyMatrix* mat, int* out){
    int index = 0;
...
int matrix_clear_y(AdjacencyMatrix* mat, int y, int* out){
    int out_index = 0;
...
int main() {
    ...
    int* free_columns = calloc(n, sizeof(int));
    //int* cleared_columns = calloc(n, sizeof(int));
    // cleared if free_columns[i] == 0
